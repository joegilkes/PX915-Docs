...
def \mbox{\hyperlink{namespacevis2_aeae9ef75e5221ae5504abe4894988757}{H2\+Energy\+Plot}} (results\+\_\+file, slice)
...
\end{DoxyCode}
\mbox{\Hypertarget{namespacevis2_aeae9ef75e5221ae5504abe4894988757}\label{namespacevis2_aeae9ef75e5221ae5504abe4894988757}} 
...
{\footnotesize\ttfamily def vis2.\+H2\+Energy\+Plot (\begin{DoxyParamCaption}\item[{}]{results\+\_\+file,  }\item[{}]{slice }\end{DoxyParamCaption})}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{122 \textcolor{keyword}{def }\mbox{\hyperlink{namespacevis2_aeae9ef75e5221ae5504abe4894988757}{H2EnergyPlot}}(results\_file, slice):}
...
\DoxyCodeLine{137 }
\DoxyCodeLine{138     bond\_lengths = dat.variables[\textcolor{stringliteral}{'Bondlength\_array'}][slice[0]:slice[1]]}
\DoxyCodeLine{139     a\_opt = dat.variables[\textcolor{stringliteral}{'Parameter\_a\_array'}][slice[0]:slice[1]]}
\DoxyCodeLine{140     beta\_opt = dat.variables[\textcolor{stringliteral}{'Parameter\_beta\_array'}][slice[0]:slice[1]]}
\DoxyCodeLine{141     energies = dat.variables[\textcolor{stringliteral}{'total\_energies'}][slice[0]:slice[1]]}
\DoxyCodeLine{142     variances = dat.variables[\textcolor{stringliteral}{'Uncertainties'}][slice[0]:slice[1]]}
\DoxyCodeLine{143 }
...
\DoxyCodeLine{163     ax2a.plot(bond\_lengths, beta\_opt, color=\textcolor{stringliteral}{'blue'})}
\DoxyCodeLine{164     ax2a.set\_ylabel(\textcolor{stringliteral}{r'\$\(\backslash\)beta\$'}, color=\textcolor{stringliteral}{'blue'})}
\DoxyCodeLine{165     ax2a.tick\_params(axis=\textcolor{stringliteral}{'y'}, labelcolor=\textcolor{stringliteral}{'blue'})}
\DoxyCodeLine{166 }
