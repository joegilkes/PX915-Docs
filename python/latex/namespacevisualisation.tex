...
\begin{DoxyCode}{0}
\DoxyCodeLine{338 \textcolor{keyword}{def }\mbox{\hyperlink{namespacevisualisation_ac345463eb554d7c90613773996e74748}{view\_original\_trace}}(filename):}
\DoxyCodeLine{339     rootgrp = Dataset(filename, \textcolor{stringliteral}{"{}r"{}}, format = \textcolor{stringliteral}{"{}NETCDF4"{}})}
\DoxyCodeLine{340     chain = np.array(rootgrp[\textcolor{stringliteral}{'positions'}][:])}
\DoxyCodeLine{341     \textcolor{keywordflow}{if} len(chain.shape) == 1:}
\DoxyCodeLine{342         plt.plot(range(len(chain)), chain, linewidth=1.0)}
\DoxyCodeLine{343         plt.xlabel(\textcolor{stringliteral}{"{}Position in chain"{}})}
\DoxyCodeLine{344         plt.ylabel(\textcolor{stringliteral}{"{}Chain value"{}})}
\DoxyCodeLine{345         plt.title(\textcolor{stringliteral}{"{}Original Chain"{}})}
\DoxyCodeLine{346         plt.show()}
\DoxyCodeLine{347         }
\DoxyCodeLine{348     \textcolor{keywordflow}{else}:}
\DoxyCodeLine{349         chainx = chain[:,0]}
\DoxyCodeLine{350         chainy = chain[:,1]}
\DoxyCodeLine{351         chainz = chain[:,2]}
\DoxyCodeLine{352         }
\DoxyCodeLine{353         fig, (ax1,ax2,ax3) = plt.subplots(3,1)}
\DoxyCodeLine{354         ax1.plot(range(len(chainx)), chainx, linewidth=1.0)}
\DoxyCodeLine{355         ax2.plot(range(len(chainy)), chainy, linewidth=1.0)}
\DoxyCodeLine{356         ax3.plot(range(len(chainz)), chainz, linewidth=1.0)}
\DoxyCodeLine{357     }
...
Definition at line 376 of file visualisation.\+py.


\begin{DoxyCode}{0}
\DoxyCodeLine{376 \textcolor{keyword}{def }\mbox{\hyperlink{namespacevisualisation_a26c9ab9270b803a8d15c40d621769c46}{get\_autocorrelation\_time}}(filename, burn, tuning, plotting=True):}
\DoxyCodeLine{377     rootgrp = Dataset(filename, \textcolor{stringliteral}{"{}r"{}}, format = \textcolor{stringliteral}{"{}NETCDF4"{}})}
\DoxyCodeLine{378     chain = np.array(rootgrp[\textcolor{stringliteral}{'positions'}][:])}
\DoxyCodeLine{379     \textcolor{keywordflow}{if} len(chain.shape) == 1:}
\DoxyCodeLine{380         acp = sps.fftconvolve(chain,chain[::-\/1],mode=\textcolor{stringliteral}{'full'})}
\DoxyCodeLine{381         acp = acp[int(acp.size / 2):]}
\DoxyCodeLine{382         acp = acp / max(acp)}
\DoxyCodeLine{383         acp = acp[burn:]}
\DoxyCodeLine{384 }
\DoxyCodeLine{385         thin = np.argmax(abs(acp) < tuning)}
\DoxyCodeLine{386         \textcolor{keywordflow}{if} thin == 0:}
\DoxyCodeLine{387             \textcolor{keywordflow}{if} acp[thin] < tuning:}
\DoxyCodeLine{388                 thin = 1}
\DoxyCodeLine{389             \textcolor{keywordflow}{else}:}
\DoxyCodeLine{390                 print(\textcolor{stringliteral}{"{}No thinning value found -\/ tuning may be too aggressive. Defaulting to no thinning, thin=1."{}})}
\DoxyCodeLine{391                 print()}
\DoxyCodeLine{392                 thin = 1}
\DoxyCodeLine{393 }
\DoxyCodeLine{394         print(\textcolor{stringliteral}{"{}burning parameter = "{}}, burn)}
\DoxyCodeLine{395         print(\textcolor{stringliteral}{"{}proposed thinning parameter = "{}}, thin)}
\DoxyCodeLine{396 }
\DoxyCodeLine{397         chain\_new = chain[burn::thin]}
\DoxyCodeLine{398         print(\textcolor{stringliteral}{"{}length of new chain = "{}}, len(chain\_new))}
\DoxyCodeLine{399 }
\DoxyCodeLine{400         \textcolor{keywordflow}{if} plotting==\textcolor{keyword}{True}:}
\DoxyCodeLine{401             plt.plot(range(len(acp)), acp, linewidth=1.0)}
\DoxyCodeLine{402             plt.xlabel(\textcolor{stringliteral}{"{}Position in chain / Lag time"{}})}
\DoxyCodeLine{403             plt.ylabel(\textcolor{stringliteral}{"{}ACF"{}})}
\DoxyCodeLine{404             plt.title(\textcolor{stringliteral}{"{}Autocorrelation function vs lag time"{}})}
\DoxyCodeLine{405             plt.show()}
\DoxyCodeLine{406 }
\DoxyCodeLine{407             plt.plot(range(len(chain\_new)), chain\_new, linewidth=1.0)}
\DoxyCodeLine{408             plt.xlabel(\textcolor{stringliteral}{"{}Position in chain"{}})}
\DoxyCodeLine{409             plt.ylabel(\textcolor{stringliteral}{"{}Chain value"{}})}
\DoxyCodeLine{410             plt.title(\textcolor{stringliteral}{"{}New Chain"{}})}
\DoxyCodeLine{411             plt.show()}
\DoxyCodeLine{412             }
\DoxyCodeLine{413         \textcolor{keywordflow}{return} burn, thin}
\DoxyCodeLine{414             }
\DoxyCodeLine{415     \textcolor{keywordflow}{else}:}
\DoxyCodeLine{416         chainx = chain[:,0]}
\DoxyCodeLine{417         chainy = chain[:,1]}
\DoxyCodeLine{418         chainz = chain[:,2]}
\DoxyCodeLine{419         }
\DoxyCodeLine{420         threed\_thin = []}
\DoxyCodeLine{421         chain\_lengths = []}
\DoxyCodeLine{422         }
\DoxyCodeLine{423         \textcolor{keywordflow}{for} c \textcolor{keywordflow}{in} [chainx,chainy,chainz]:}
\DoxyCodeLine{424             acp = sps.fftconvolve(c,c[::-\/1],mode=\textcolor{stringliteral}{'full'})}
\DoxyCodeLine{425             acp = acp[int(acp.size / 2):]}
\DoxyCodeLine{426             acp = acp / max(acp)}
\DoxyCodeLine{427             acp = acp[burn:]}
\DoxyCodeLine{428 }
\DoxyCodeLine{429             thin = np.argmax(abs(acp) < tuning)}
\DoxyCodeLine{430             \textcolor{keywordflow}{if} thin == 0:}
\DoxyCodeLine{431                 \textcolor{keywordflow}{if} acp[thin] < tuning:}
\DoxyCodeLine{432                     thin = 1}
\DoxyCodeLine{433                 \textcolor{keywordflow}{else}:}
\DoxyCodeLine{434                     print(\textcolor{stringliteral}{"{}No thinning value found -\/ tuning may be too aggressive. Defaulting to no thinning, thin=1."{}})}
\DoxyCodeLine{435                     print()}
\DoxyCodeLine{436                     thin = 1}
\DoxyCodeLine{437                     }
\DoxyCodeLine{438             threed\_thin.append(thin)}
\DoxyCodeLine{439 }
\DoxyCodeLine{440             chain\_new = c[burn::thin]}
\DoxyCodeLine{441             chain\_lengths.append(len(chain\_new))}
\DoxyCodeLine{442 }
\DoxyCodeLine{443             \textcolor{keywordflow}{if} plotting==\textcolor{keyword}{True}:}
\DoxyCodeLine{444                 plt.plot(range(len(acp)), acp, linewidth=1.0)}
\DoxyCodeLine{445                 plt.xlabel(\textcolor{stringliteral}{"{}Position in chain / Lag time"{}})}
\DoxyCodeLine{446                 plt.ylabel(\textcolor{stringliteral}{"{}ACF"{}})}
\DoxyCodeLine{447                 plt.title(\textcolor{stringliteral}{"{}Autocorrelation function vs lag time"{}})}
\DoxyCodeLine{448                 plt.show()}
\DoxyCodeLine{449 }
\DoxyCodeLine{450 \textcolor{comment}{\#                 plt.plot(range(len(chain\_new)), chain\_new, linewidth=1.0)}}
\DoxyCodeLine{451 \textcolor{comment}{\#                 plt.xlabel("{}Position in chain"{})}}
\DoxyCodeLine{452 \textcolor{comment}{\#                 plt.ylabel("{}Chain value"{})}}
\DoxyCodeLine{453 \textcolor{comment}{\#                 plt.title("{}New Chain"{})}}
\DoxyCodeLine{454 \textcolor{comment}{\#                 plt.show()}}
\DoxyCodeLine{455         print(\textcolor{stringliteral}{"{}burning parameter = "{}}, burn)}
\DoxyCodeLine{456         print(\textcolor{stringliteral}{"{}proposed thinning parameters from the 3 chains: "{}}, threed\_thin)}
\DoxyCodeLine{457         print(\textcolor{stringliteral}{"{}chain lengths from proposed thins"{}}, chain\_lengths)}
\DoxyCodeLine{458 }
\DoxyCodeLine{459         \textcolor{keywordflow}{return} burn, threed\_thin}
\DoxyCodeLine{460 }
\DoxyCodeLine{461 }
\DoxyCodeLine{462 }
\DoxyCodeLine{463 }
