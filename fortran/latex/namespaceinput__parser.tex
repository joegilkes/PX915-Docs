...
\DoxyCodeLine{249 }
\DoxyCodeLine{250             \textcolor{comment}{! Update grid-\/loop start values}}
\DoxyCodeLine{251             \textcolor{comment}{! TO DO: Remove res\%step if James confirms that chain-\/restarts are not required.}}
\DoxyCodeLine{252             \textcolor{keywordflow}{if} (trim(p\_system) == \textcolor{stringliteral}{'QHO'}) \textcolor{keywordflow}{then}}
\DoxyCodeLine{253                 \textcolor{keywordflow}{if} (res\%step == 0) \textcolor{keywordflow}{then}}
\DoxyCodeLine{254                     alpha\_start = res\%i\_alpha}
\DoxyCodeLine{255                 \textcolor{keywordflow}{else} }
\DoxyCodeLine{256                     alpha\_start = res\%i\_alpha+1}
\DoxyCodeLine{257 \textcolor{keywordflow}{                endif} }
\DoxyCodeLine{258             \textcolor{keywordflow}{else} }
\DoxyCodeLine{259                 \textcolor{keywordflow}{if} (res\%step == 0) \textcolor{keywordflow}{then}}
\DoxyCodeLine{260                     bond\_start = res\%i\_bond}
\DoxyCodeLine{261                 \textcolor{keywordflow}{else} }
\DoxyCodeLine{262                     bond\_start = res\%i\_bond+1}
...
\DoxyCodeLine{267             \textcolor{keyword}{write}(*, \textcolor{stringliteral}{"{}('-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/ Restarted Program -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/')"{}}\textcolor{comment}{)}}
\DoxyCodeLine{268 \textcolor{comment}{}            \textcolor{keyword}{write}(*, \textcolor{stringliteral}{"{}('')"{}})}
\DoxyCodeLine{269 }
