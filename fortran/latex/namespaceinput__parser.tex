...
\DoxyCodeLine{251             \textcolor{keywordflow}{if} (trim(p\_system) == \textcolor{stringliteral}{'QHO'}) \textcolor{keywordflow}{then}}
\DoxyCodeLine{252                 alpha\_start = res\%i\_qoi}
\DoxyCodeLine{253             \textcolor{keywordflow}{else} }
\DoxyCodeLine{254                 bond\_start = res\%i\_qoi}
\DoxyCodeLine{255                 \textcolor{keywordflow}{if} (res\%auto) \textcolor{keywordflow}{then}}
\DoxyCodeLine{256                     \textcolor{comment}{! For auto-\/search routines}}
\DoxyCodeLine{257                     auto\_start = res\%i\_par}
\DoxyCodeLine{258                 \textcolor{keywordflow}{else} }
\DoxyCodeLine{259                     \textcolor{comment}{! For grid-\/search routines}}
\DoxyCodeLine{260                     grid\_start = res\%i\_par}
\DoxyCodeLine{261 \textcolor{keywordflow}{                endif}}
\DoxyCodeLine{262 }
\DoxyCodeLine{263 \textcolor{keywordflow}{            endif}}
\DoxyCodeLine{264 }
\DoxyCodeLine{265             \textcolor{comment}{! Print restarts header.}}
\DoxyCodeLine{266             \textcolor{keyword}{write}(*, \textcolor{stringliteral}{"{}('-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/ Restarted Program -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/')"{}}\textcolor{comment}{)}}
\DoxyCodeLine{267 \textcolor{comment}{}            \textcolor{keyword}{write}(*, \textcolor{stringliteral}{"{}('')"{}})}
\DoxyCodeLine{268 }
