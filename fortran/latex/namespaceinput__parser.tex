...
\DoxyCodeLine{61             error stop \textcolor{stringliteral}{'Error: Oops, invalid CONTROL namelist format in file "{}params.txt"{}.'}}
...
\DoxyCodeLine{88             error stop \textcolor{stringliteral}{'Error: Oops, invalid PARAMETERS namelist for QHO p\_system in file "{}params.txt"{}.'}}
...
\DoxyCodeLine{115             error stop \textcolor{stringliteral}{'Error: Oops, invalid PARAMETERS namelist for H2plus p\_system in file "{}params.txt"{}.'}}
...
\DoxyCodeLine{142             error stop \textcolor{stringliteral}{'Error: Oops, invalid PARAMETERS namelist for H2 p\_system in file "{}params.txt"{}.'}}
...
\DoxyCodeLine{169             error stop \textcolor{stringliteral}{'Error: Oops, input file "{}params.txt"{} does not exist.'}}
...
\DoxyCodeLine{199                 error stop \textcolor{stringliteral}{'Error: Oops, invalid system definition.'}}
...
\DoxyCodeLine{212             error stop \textcolor{stringliteral}{'Error: Oops, invalid system definition.'}}
