...
\DoxyCodeLine{413         \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (burn >= 2)}
...
\DoxyCodeLine{934                 \textcolor{comment}{! Propose the next step for random walker 1 }}
\DoxyCodeLine{935                 \textcolor{keyword}{call }random\_normal(3, sample\_normal)}
\DoxyCodeLine{936                 x\_n\_1 = x\_1(:, i-\/1) + sigma * sample\_normal}
\DoxyCodeLine{937 }
\DoxyCodeLine{938                 \textcolor{comment}{! Propose the next step for random walker 2 }}
\DoxyCodeLine{939                 \textcolor{keyword}{call }random\_normal(3, sample\_normal)}
\DoxyCodeLine{940                 x\_n\_2 = x\_2(:, i-\/1) + sigma * sample\_normal}
\DoxyCodeLine{941 }
\DoxyCodeLine{942                 \textcolor{comment}{! Calculate the transition probability between the proposed steps and current steps}}
\DoxyCodeLine{943                 log\_prob\_n = log(h\_2\_prob(c\_const, x\_1(:, i-\/1), x\_2(:, i\textcolor{comment}{-\/1), x\_n\_1, x\_n\_2, r\_a, r\_b))}}
...
\DoxyCodeLine{953                     \textcolor{comment}{! If accepted calculate local energy and add proposed position to the MCMC chain}}
\DoxyCodeLine{954                     x\_1(:, i) = x\_n\_1}
\DoxyCodeLine{955                     x\_2(:, i) = x\_n\_2 }
\DoxyCodeLine{956 }
\DoxyCodeLine{957                     \textcolor{comment}{! To determine whether this point should be added to the burnt and thinned MCMC chain                                        }}
\DoxyCodeLine{958                     \textcolor{keywordflow}{if} ((i > (burn + 1)) .and. (thin\_counter == thin)) \textcolor{keywordflow}{then}}
\DoxyCodeLine{959                         \textcolor{comment}{! Increment the reset counter }}
\DoxyCodeLine{960                         reset\_counter = 1 + reset\_counter}
\DoxyCodeLine{961                         \textcolor{comment}{! Precalculate i\_bt for shorthand}}
\DoxyCodeLine{962                         i\_bt = i -\/ burn -\/ (reset\_counter * (thin -\/ 1))}
\DoxyCodeLine{963                         \textcolor{comment}{! Add to the burn and thinned MCMC chain}}
\DoxyCodeLine{964                         x\_1\_burnt(:, i\_bt) = x\_n\_1}
\DoxyCodeLine{965                         x\_2\_burnt(:, i\_bt) = x\_n\_2}
\DoxyCodeLine{966                         \textcolor{comment}{! Calculate the local energy at this point }}
\DoxyCodeLine{967                         energy\_chain(i\_bt) = h\_2\_energy(c\_const, x\_n\_1, x\_n\_2\textcolor{comment}{, r\_a, r\_b)}}
\DoxyCodeLine{968 \textcolor{comment}{}                        \textcolor{comment}{! Resetting the thin counter }}
\DoxyCodeLine{969                         thin\_counter = 0}
\DoxyCodeLine{970 }
\DoxyCodeLine{971                         \textcolor{comment}{! Increment the number of accepted steps }}
\DoxyCodeLine{972                         accept = 1 + accept }
\DoxyCodeLine{973 \textcolor{keywordflow}{                    end if} }
\DoxyCodeLine{974                 \textcolor{keywordflow}{else} }
\DoxyCodeLine{975                     \textcolor{comment}{! If rejected the proposed step is the current step }}
\DoxyCodeLine{976                     x\_1(:, i) = x\_1(:, i-\/1)}
\DoxyCodeLine{977                     x\_2(:, i) = x\_2(:, i-\/1) }
\DoxyCodeLine{978                 }
\DoxyCodeLine{979                     \textcolor{comment}{! To determine whether this point should be added to the burnt and thinned MCMC chain}}
\DoxyCodeLine{980                     \textcolor{keywordflow}{if} ((i > (burn + 1)) .and. (thin\_counter == thin)) \textcolor{keywordflow}{then}}
\DoxyCodeLine{981                         \textcolor{comment}{! Increment the reset counter }}
\DoxyCodeLine{982                         reset\_counter = 1 + reset\_counter}
\DoxyCodeLine{983                         \textcolor{comment}{! Precalculate i\_bt for shorthand}}
\DoxyCodeLine{984                         i\_bt = i -\/ burn -\/ (reset\_counter * (thin -\/ 1))}
\DoxyCodeLine{985                         \textcolor{comment}{! Add to the burn and thinned MCMC chain}}
\DoxyCodeLine{986                         x\_1\_burnt(:, i\_bt) = x\_1(:, i-\/1)}
\DoxyCodeLine{987                         x\_2\_burnt(:, i\_bt) = x\_2(:, i-\/1)}
\DoxyCodeLine{988                         \textcolor{comment}{! Calculate the local energy at this point }}
\DoxyCodeLine{989                         energy\_chain(i\_bt) = h\_2\_energy(c\_const, x\_1(:, i\textcolor{comment}{-\/1), x\_2(:, i-\/1), r\_a, r\_b)}}
\DoxyCodeLine{990 \textcolor{comment}{}                        \textcolor{comment}{! Resetting the thin counter }}
\DoxyCodeLine{991                         thin\_counter = 0}
...
\DoxyCodeLine{995         \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (burn >= 2) \textcolor{keywordflow}{then} }
\DoxyCodeLine{996             \textcolor{keywordflow}{do} i = 2, burn }
\DoxyCodeLine{997                 \textcolor{comment}{! Propose the next step for random walker 1 }}
\DoxyCodeLine{998                 \textcolor{keyword}{call }random\_normal(3, sample\_normal)}
\DoxyCodeLine{999                 x\_n\_1 = x\_1(:, i-\/1) + sigma * sample\_normal}
\DoxyCodeLine{1000 }
\DoxyCodeLine{1001                 \textcolor{comment}{! Propose the next step for random walker 2 }}
\DoxyCodeLine{1002                 \textcolor{keyword}{call }random\_normal(3, sample\_normal)}
\DoxyCodeLine{1003                 x\_n\_2 = x\_2(:, i-\/1) + sigma * sample\_normal}
\DoxyCodeLine{1004 }
\DoxyCodeLine{1005                 \textcolor{comment}{! Calculate the transition probability between the proposed steps and current steps}}
\DoxyCodeLine{1006                 log\_prob\_n = log(h\_2\_prob(c\_const, x\_1(:, i-\/1), x\_2(:, i\textcolor{comment}{-\/1), x\_n\_1, x\_n\_2, r\_a, r\_b))}}
\DoxyCodeLine{1007 \textcolor{comment}{}}
\DoxyCodeLine{1008                 \textcolor{comment}{! Calculate the acceptance ratio}}
\DoxyCodeLine{1009                 a\_prob\_trans = min(1.0\_real64, exp(log\_prob\_n))}
\DoxyCodeLine{1010 }
\DoxyCodeLine{1011                 \textcolor{comment}{! Generate sample from uniform distribution}}
\DoxyCodeLine{1012                 \textcolor{keyword}{call }ran1(unif\_num, seed)}
\DoxyCodeLine{1013 }
\DoxyCodeLine{1014                 \textcolor{comment}{! Compare the drawn sample from the uniform distribution with the acceptance ratio}}
\DoxyCodeLine{1015                 \textcolor{keywordflow}{if} (a\_prob\_trans >= unif\_num) \textcolor{keywordflow}{then} }
\DoxyCodeLine{1016                     \textcolor{comment}{! If accepted calculate local energy and add proposed position to the MCMC chain}}
\DoxyCodeLine{1017                     x\_1(:, i) = x\_n\_1}
\DoxyCodeLine{1018                     x\_2(:, i) = x\_n\_2 }
\DoxyCodeLine{1019                 \textcolor{keywordflow}{else} }
\DoxyCodeLine{1020                     \textcolor{comment}{! If rejected the proposed step is the current step }}
\DoxyCodeLine{1021                     x\_1(:, i) = x\_1(:, i-\/1)}
\DoxyCodeLine{1022                     x\_2(:, i) = x\_2(:, i-\/1) }
...
\DoxyCodeLine{1026         }
\DoxyCodeLine{1027         \textcolor{keywordflow}{if} (burn >= 1) \textcolor{keywordflow}{then} }
\DoxyCodeLine{1028             \textcolor{comment}{! Metropolis algorithm }}
\DoxyCodeLine{1029             \textcolor{keywordflow}{do} i = (burn + 1) , n+1 }
\DoxyCodeLine{1030                 \textcolor{comment}{! Propose the next step for random walker 1 }}
\DoxyCodeLine{1031                 \textcolor{keyword}{call }random\_normal(3, sample\_normal)}
\DoxyCodeLine{1032                 x\_n\_1 = x\_1(:, i-\/1) + sigma * sample\_normal}
\DoxyCodeLine{1033 }
\DoxyCodeLine{1034                 \textcolor{comment}{! Propose the next step for random walker 2 }}
\DoxyCodeLine{1035                 \textcolor{keyword}{call }random\_normal(3, sample\_normal)}
\DoxyCodeLine{1036                 x\_n\_2 = x\_2(:, i-\/1) + sigma * sample\_normal}
\DoxyCodeLine{1037 }
\DoxyCodeLine{1038                 \textcolor{comment}{! Calculate the transition probability between the proposed steps and current steps}}
\DoxyCodeLine{1039                 log\_prob\_n = log(h\_2\_prob(c\_const, x\_1(:, i-\/1), x\_2(:, i\textcolor{comment}{-\/1), x\_n\_1, x\_n\_2, r\_a, r\_b))}}
\DoxyCodeLine{1040 \textcolor{comment}{}}
\DoxyCodeLine{1041                 \textcolor{comment}{! Calculate the acceptance ratio}}
\DoxyCodeLine{1042                 a\_prob\_trans = min(1.0\_real64, exp(log\_prob\_n))}
\DoxyCodeLine{1043 }
\DoxyCodeLine{1044                 \textcolor{comment}{! Generate sample from uniform distribution}}
\DoxyCodeLine{1045                 \textcolor{keyword}{call }ran1(unif\_num, seed)}
\DoxyCodeLine{1046 }
\DoxyCodeLine{1047                 \textcolor{comment}{! Compare the drawn sample from the uniform distribution with the acceptance ratio}}
\DoxyCodeLine{1048                 \textcolor{keywordflow}{if} (a\_prob\_trans >= unif\_num) \textcolor{keywordflow}{then} }
\DoxyCodeLine{1049                     \textcolor{comment}{! If accepted calculate local energy and add proposed position to the MCMC chain}}
\DoxyCodeLine{1050                     x\_1(:, i) = x\_n\_1}
\DoxyCodeLine{1051                     x\_2(:, i) = x\_n\_2 }
\DoxyCodeLine{1052 }
\DoxyCodeLine{1053                     \textcolor{comment}{! To determine whether this point should be added to the burnt and thinned MCMC chain                    }}
\DoxyCodeLine{1054                     \textcolor{keywordflow}{if} ((i > (burn + 1)) .and. (thin\_counter == thin)) \textcolor{keywordflow}{then}}
\DoxyCodeLine{1055                         \textcolor{comment}{! Increment the reset counter }}
\DoxyCodeLine{1056                         reset\_counter = 1 + reset\_counter}
\DoxyCodeLine{1057                         \textcolor{comment}{! Precalculate i\_bt for shorthand}}
\DoxyCodeLine{1058                         i\_bt = i -\/ burn -\/ (reset\_counter * (thin -\/ 1))}
\DoxyCodeLine{1059                         \textcolor{comment}{! Add to the burn and thinned MCMC chain}}
\DoxyCodeLine{1060                         x\_1\_burnt(:, i\_bt) = x\_n\_1}
\DoxyCodeLine{1061                         x\_2\_burnt(:, i\_bt) = x\_n\_2}
\DoxyCodeLine{1062                         \textcolor{comment}{! Calculate the local energy at this point }}
\DoxyCodeLine{1063                         energy\_chain(i\_bt) = h\_2\_energy(c\_const, x\_n\_1, x\_n\_2\textcolor{comment}{, r\_a, r\_b)}}
\DoxyCodeLine{1064 \textcolor{comment}{}                        \textcolor{comment}{! Resetting the thin counter }}
\DoxyCodeLine{1065                         thin\_counter = 0}
\DoxyCodeLine{1066 }
\DoxyCodeLine{1067                         \textcolor{comment}{! Increment the number of accepted steps }}
\DoxyCodeLine{1068                         accept = 1 + accept }
\DoxyCodeLine{1069 \textcolor{keywordflow}{                    end if} }
\DoxyCodeLine{1070                 \textcolor{keywordflow}{else} }
\DoxyCodeLine{1071                     \textcolor{comment}{! If rejected the proposed step is the current step }}
\DoxyCodeLine{1072                     x\_1(:, i) = x\_1(:, i-\/1)}
\DoxyCodeLine{1073                     x\_2(:, i) = x\_2(:, i-\/1) }
\DoxyCodeLine{1074                 }
\DoxyCodeLine{1075                     \textcolor{comment}{! To determine whether this point should be added to the burnt and thinned MCMC chain                }}
\DoxyCodeLine{1076                     \textcolor{keywordflow}{if} ((i > (burn + 1)) .and. (thin\_counter == thin)) \textcolor{keywordflow}{then}}
\DoxyCodeLine{1077                         \textcolor{comment}{! Increment the reset counter }}
\DoxyCodeLine{1078                         reset\_counter = 1 + reset\_counter}
\DoxyCodeLine{1079                         \textcolor{comment}{! Precalculate i\_bt for shorthand}}
\DoxyCodeLine{1080                         i\_bt = i -\/ burn -\/ (reset\_counter * (thin -\/ 1))}
\DoxyCodeLine{1081                         \textcolor{comment}{! Add to the burn and thinned MCMC chain}}
\DoxyCodeLine{1082                         x\_1\_burnt(:, i\_bt) = x\_1(:, i-\/1)}
\DoxyCodeLine{1083                         x\_2\_burnt(:, i\_bt) = x\_2(:, i-\/1)}
\DoxyCodeLine{1084                         \textcolor{comment}{! Calculate the local energy at this point }}
\DoxyCodeLine{1085                         energy\_chain(i\_bt) = h\_2\_energy(c\_const, x\_1(:, i\textcolor{comment}{-\/1), x\_2(:, i-\/1), r\_a, r\_b)}}
\DoxyCodeLine{1086 \textcolor{comment}{}                        \textcolor{comment}{! Resetting the thin counter }}
\DoxyCodeLine{1087                         thin\_counter = 0}
...
\DoxyCodeLine{1092 }
\DoxyCodeLine{1093         \textcolor{comment}{! Calculate the acceptance ratio}}
\DoxyCodeLine{1094         accept\_rate = (real(accept, kind=real64) / real(re\_size, kind=real64\textcolor{comment}{)) }}
