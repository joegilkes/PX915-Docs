...
Definition at line 239 of file restart\+\_\+fns.\+f90.


\begin{DoxyCode}{0}
\DoxyCodeLine{240 }
\DoxyCodeLine{241         \textcolor{comment}{! Local variables}}
\DoxyCodeLine{242 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(:)}, \textcolor{keywordtype}{allocatable}, \textcolor{keywordtype}{intent(out)} :: energy\_chain}
\DoxyCodeLine{243 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{intent(out)} :: accept\_rate}
\DoxyCodeLine{244         \textcolor{keywordtype}{integer} :: ierr, file\_id, var\_id}
\DoxyCodeLine{245 }
\DoxyCodeLine{246         \textcolor{comment}{! Check if file exists}}
\DoxyCodeLine{247         \textcolor{keyword}{inquire}(file=resfile\_chn, iostat=rc)}
\DoxyCodeLine{248         \textcolor{keywordflow}{if} (rc /= 0) \textcolor{keywordflow}{then}}
\DoxyCodeLine{249             print*, \textcolor{stringliteral}{'Searched for file '}, resfile\_chn, \textcolor{stringliteral}{' .'}}
\DoxyCodeLine{250             error stop \textcolor{stringliteral}{'Error: This restart file is not present in the current directory.'}}
\DoxyCodeLine{251 \textcolor{keywordflow}{        end if}}
\DoxyCodeLine{252 }
\DoxyCodeLine{253         \textcolor{comment}{! Open restart netCDF file with chains}}
\DoxyCodeLine{254         ierr = nf90\_open(resfile\_chn, nf90\_nowrite, file\_id)}
\DoxyCodeLine{255         \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{256 }
\DoxyCodeLine{257         \textcolor{comment}{!! Get var\_id for energy\_chain -\/ called 'Trace' in the netcdf file}}
\DoxyCodeLine{258         ierr = nf90\_inq\_varid(file\_id, \textcolor{stringliteral}{"{}Trace"{}}, var\_id)}
\DoxyCodeLine{259         \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{260 }
\DoxyCodeLine{261         \textcolor{comment}{! Read the energy\_chain}}
\DoxyCodeLine{262         ierr = nf90\_get\_var(file\_id, var\_id, energy\_chain)}
\DoxyCodeLine{263         \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{264 }
\DoxyCodeLine{265         \textcolor{comment}{! Get attribute accept\_rate}}
\DoxyCodeLine{266         ierr = nf90\_get\_att(file\_id, nf90\_global, \textcolor{stringliteral}{"{}accept\_rate"{}}, accept\_rate\textcolor{comment}{)}}
\DoxyCodeLine{267 \textcolor{comment}{}        \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{268         }
\DoxyCodeLine{269         \textcolor{comment}{! Close the file}}
