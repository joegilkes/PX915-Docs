...
{\footnotesize\ttfamily subroutine restart\+\_\+fns\+::read\+\_\+energies (\begin{DoxyParamCaption}\item[{character(len=$\ast$), intent(in)}]{filename,  }\item[{real(real64), dimension(\+:), intent(out)}]{energies,  }\item[{real(real64), dimension(\+:), intent(out)}]{variances,  }\item[{real(real64), dimension(\+:), intent(out)}]{accept\+\_\+rates }\end{DoxyParamCaption})}
...
\DoxyCodeLine{180 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(:)}, \textcolor{keywordtype}{intent(out)} :: energies, variances, accept\_rates}
...
{\footnotesize\ttfamily subroutine restart\+\_\+fns\+::read\+\_\+energies\+\_\+h2plus (\begin{DoxyParamCaption}\item[{character(len=$\ast$), intent(in)}]{filename,  }\item[{real(real64), dimension(\+:), intent(out)}]{energies,  }\item[{real(real64), dimension(\+:), intent(out)}]{variances,  }\item[{real(real64), dimension(\+:), intent(out)}]{accept\+\_\+rates,  }\item[{real(real64), dimension(\+:), intent(out)}]{c\+\_\+array }\end{DoxyParamCaption})}
...
\DoxyCodeLine{242 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(:)}, \textcolor{keywordtype}{intent(out)} :: energies, variances, accept\_rates, c\_array}
...
{\footnotesize\ttfamily subroutine restart\+\_\+fns\+::read\+\_\+energies\+\_\+h2 (\begin{DoxyParamCaption}\item[{character(len=$\ast$), intent(in)}]{filename,  }\item[{real(real64), dimension(\+:), intent(out)}]{energies,  }\item[{real(real64), dimension(\+:), intent(out)}]{variances,  }\item[{real(real64), dimension(\+:), intent(out)}]{accept\+\_\+rates,  }\item[{real(real64), dimension(\+:), intent(out)}]{a\+\_\+array,  }\item[{real(real64), dimension(\+:), intent(out)}]{b\+\_\+array }\end{DoxyParamCaption})}
...
\DoxyCodeLine{313 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(:)}, \textcolor{keywordtype}{intent(out)} :: energies, variances, accept\_rates, a\_array, b\_array}
