...
\begin{DoxyCompactList}\small\item\em Subroutine that reads restart file with energy chains (res\+\_\+chains.\+nc) \mbox{[}UNUSED\mbox{]}. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\DoxyCodeLine{98         \textcolor{keywordflow}{case} (\textcolor{stringliteral}{'H2'})}
\DoxyCodeLine{99             res\%i\_bond = i1}
\DoxyCodeLine{100             res\%i\_c1 = i2}
\DoxyCodeLine{101 \textcolor{keywordflow}{        case default}}
\DoxyCodeLine{102             error stop \textcolor{stringliteral}{'Error: Invalid "{}p\_system"{} passed to function write\_res\_params().'}}
\DoxyCodeLine{103 \textcolor{keywordflow}{        end select}}
\DoxyCodeLine{104 }
\DoxyCodeLine{105         \textcolor{comment}{! Open the res\_paramts.txt file}}
\DoxyCodeLine{106         \textcolor{keyword}{open}(action=\textcolor{stringliteral}{'write'}, file=resfile\_nml, iostat=rc, newunit=fu)}
\DoxyCodeLine{107 }
\DoxyCodeLine{108         \textcolor{comment}{! Write the RESTART namelist}}
\DoxyCodeLine{109         \textcolor{keyword}{write}(nml=restart, iostat=rc, unit=fu)}
\DoxyCodeLine{110         \textcolor{keywordflow}{if} (rc /= 0) \textcolor{keywordflow}{then}}
\DoxyCodeLine{111             error stop \textcolor{stringliteral}{'Error: Invalid RESTART namelist defined in function write\_res\_params().'}}
\DoxyCodeLine{112 \textcolor{keywordflow}{        end if}}
\DoxyCodeLine{113         }
\DoxyCodeLine{114         \textcolor{comment}{! Close the res\_paramts.txt file}}
\DoxyCodeLine{115         \textcolor{keyword}{close}(fu)}
\DoxyCodeLine{116 }
...
Definition at line 136 of file restart\+\_\+fns.\+f90.


\begin{DoxyCode}{0}
\DoxyCodeLine{137 }
\DoxyCodeLine{138         \textcolor{comment}{! Local variables}}
\DoxyCodeLine{139         \textcolor{keywordtype}{type}(restart\_type), \textcolor{keywordtype}{intent(out)} :: res}
\DoxyCodeLine{140 }
\DoxyCodeLine{141         \textcolor{comment}{! Define the namelist}}
\DoxyCodeLine{142         namelist /restart/ res}
\DoxyCodeLine{143 }
\DoxyCodeLine{144         \textcolor{comment}{! Check if file exists}}
\DoxyCodeLine{145         \textcolor{keyword}{inquire}(file=resfile\_nml, iostat=rc)}
\DoxyCodeLine{146         \textcolor{keywordflow}{if} (rc /= 0) \textcolor{keywordflow}{then}}
\DoxyCodeLine{147             print*, \textcolor{stringliteral}{'Searched for file '}, resfile\_nml, \textcolor{stringliteral}{' .'}}
\DoxyCodeLine{148             error stop \textcolor{stringliteral}{'Error: This restart file is not present in the current directory.'}}
\DoxyCodeLine{149 \textcolor{keywordflow}{        end if}}
\DoxyCodeLine{150 }
\DoxyCodeLine{151         \textcolor{comment}{! Open the file}}
\DoxyCodeLine{152         \textcolor{keyword}{open}(action=\textcolor{stringliteral}{'read'}, file=resfile\_nml, iostat=rc, newunit=fu)}
\DoxyCodeLine{153 }
\DoxyCodeLine{154         \textcolor{comment}{! Read the namelist}}
\DoxyCodeLine{155         \textcolor{keyword}{read}(nml=restart, iostat=rc, unit=fu)}
\DoxyCodeLine{156         \textcolor{keywordflow}{if} (rc /= 0) \textcolor{keywordflow}{then}}
\DoxyCodeLine{157             error stop \textcolor{stringliteral}{'Error: Invalid RESTART namelist in "{}res\_nml.txt"{}.'}}
\DoxyCodeLine{158 \textcolor{keywordflow}{        end if}}
\DoxyCodeLine{159         }
\DoxyCodeLine{160         \textcolor{comment}{! Close the file}}
\DoxyCodeLine{161         \textcolor{keyword}{close}(fu)}
\DoxyCodeLine{162 }
...
Definition at line 178 of file restart\+\_\+fns.\+f90.


\begin{DoxyCode}{0}
\DoxyCodeLine{179         \textcolor{keywordtype}{integer},\textcolor{keywordtype}{intent(in)} :: ierr}
\DoxyCodeLine{180         \textcolor{keywordflow}{if} (ierr /= nf90\_noerr) \textcolor{keywordflow}{then}}
\DoxyCodeLine{181             print*, trim(nf90\_strerror(ierr))}
...
\hline
\mbox{\texttt{ out}}  & {\em energies} & Array to store restart energies \\
\hline
\mbox{\texttt{ out}}  & {\em accept\+\_\+rates} & Array to store restart acceptence rates \\
\hline
\end{DoxyParams}


Definition at line 201 of file restart\+\_\+fns.\+f90.


\begin{DoxyCode}{0}
\DoxyCodeLine{202 }
\DoxyCodeLine{203         \textcolor{comment}{! Local variables}}
\DoxyCodeLine{204         \textcolor{keywordtype}{character(len=*)}, \textcolor{keywordtype}{intent(in)} :: filename}
\DoxyCodeLine{205 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(:)}, \textcolor{keywordtype}{allocatable}, \textcolor{keywordtype}{intent(out)} :: energies, accept\_rates}
\DoxyCodeLine{206         \textcolor{keywordtype}{integer} :: ierr, file\_id, var\_id}
\DoxyCodeLine{207 }
\DoxyCodeLine{208         \textcolor{comment}{! Check if file exists}}
\DoxyCodeLine{209         \textcolor{keyword}{inquire}(file=filename, iostat=rc)}
\DoxyCodeLine{210         \textcolor{keywordflow}{if} (rc /= 0) \textcolor{keywordflow}{then}}
\DoxyCodeLine{211             print*, \textcolor{stringliteral}{'Searched for file '}, filename, \textcolor{stringliteral}{' .'}}
\DoxyCodeLine{212             error stop \textcolor{stringliteral}{'Error: This restart file is not present in the current directory.'}}
\DoxyCodeLine{213 \textcolor{keywordflow}{        end if}}
\DoxyCodeLine{214 }
\DoxyCodeLine{215         \textcolor{comment}{! Open restart netCDF file with energies}}
\DoxyCodeLine{216         ierr = nf90\_open(filename, nf90\_nowrite, file\_id)}
\DoxyCodeLine{217         \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{218 }
\DoxyCodeLine{219         \textcolor{comment}{! Get var\_id for total\_energies}}
\DoxyCodeLine{220         ierr = nf90\_inq\_varid(file\_id, \textcolor{stringliteral}{"{}total\_energies"{}}, var\_id)}
\DoxyCodeLine{221         \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{222 }
\DoxyCodeLine{223         \textcolor{comment}{! Read the total\_energies}}
\DoxyCodeLine{224         ierr = nf90\_get\_var(file\_id, var\_id, energies)}
\DoxyCodeLine{225         \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{226 }
\DoxyCodeLine{227         \textcolor{comment}{! Get attribute accept\_rate}}
\DoxyCodeLine{228         ierr = nf90\_get\_att(file\_id, nf90\_global, \textcolor{stringliteral}{"{}accept\_rate"{}}, accept\_rates)}
\DoxyCodeLine{229         \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{230         }
\DoxyCodeLine{231         \textcolor{comment}{! Close the file}}
\DoxyCodeLine{232         ierr = nf90\_close(file\_id)}
\DoxyCodeLine{233         \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{234 }
...
Subroutine that reads restart file with energy chains (res\+\_\+chains.\+nc) \mbox{[}UNUSED\mbox{]}. 



Definition at line 244 of file restart\+\_\+fns.\+f90.


\begin{DoxyCode}{0}
\DoxyCodeLine{245 }
\DoxyCodeLine{246         \textcolor{comment}{! Local variables}}
\DoxyCodeLine{247 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(:)}, \textcolor{keywordtype}{allocatable}, \textcolor{keywordtype}{intent(out)} :: energy\_chain}
\DoxyCodeLine{248 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{intent(out)} :: accept\_rate}
\DoxyCodeLine{249         \textcolor{keywordtype}{integer} :: ierr, file\_id, var\_id}
\DoxyCodeLine{250 }
\DoxyCodeLine{251         \textcolor{comment}{! Check if file exists}}
\DoxyCodeLine{252         \textcolor{keyword}{inquire}(file=resfile\_chn, iostat=rc)}
\DoxyCodeLine{253         \textcolor{keywordflow}{if} (rc /= 0) \textcolor{keywordflow}{then}}
\DoxyCodeLine{254             print*, \textcolor{stringliteral}{'Searched for file '}, resfile\_chn, \textcolor{stringliteral}{' .'}}
\DoxyCodeLine{255             error stop \textcolor{stringliteral}{'Error: This restart file is not present in the current directory.'}}
\DoxyCodeLine{256 \textcolor{keywordflow}{        end if}}
\DoxyCodeLine{257 }
\DoxyCodeLine{258         \textcolor{comment}{! Open restart netCDF file with chains}}
\DoxyCodeLine{259         ierr = nf90\_open(resfile\_chn, nf90\_nowrite, file\_id)}
\DoxyCodeLine{260         \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{261 }
\DoxyCodeLine{262         \textcolor{comment}{!! Get var\_id for energy\_chain -\/ called 'Trace' in the netcdf file}}
\DoxyCodeLine{263         ierr = nf90\_inq\_varid(file\_id, \textcolor{stringliteral}{"{}Trace"{}}, var\_id)}
\DoxyCodeLine{264         \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{265 }
\DoxyCodeLine{266         \textcolor{comment}{! Read the energy\_chain}}
\DoxyCodeLine{267         ierr = nf90\_get\_var(file\_id, var\_id, energy\_chain)}
\DoxyCodeLine{268         \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{269 }
\DoxyCodeLine{270         \textcolor{comment}{! Get attribute accept\_rate}}
\DoxyCodeLine{271         ierr = nf90\_get\_att(file\_id, nf90\_global, \textcolor{stringliteral}{"{}accept\_rate"{}}, accept\_rate\textcolor{comment}{)}}
\DoxyCodeLine{272 \textcolor{comment}{}        \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{273         }
\DoxyCodeLine{274         \textcolor{comment}{! Close the file}}
\DoxyCodeLine{275         ierr = nf90\_close(file\_id)}
