...
\DoxyCodeLine{77                 error stop \textcolor{stringliteral}{'Error: Oops, electron position ("{}pos1"{}) missing in inputs to write\_res\_params(). :-\/( '}}
...
\DoxyCodeLine{85                     error stop \textcolor{stringliteral}{'Error: Oops, electron position ("{}pos2"{}) missing in inputs to write\_res\_params(). :-\/( '}}
...
\DoxyCodeLine{102                     error stop \textcolor{stringliteral}{'Error: Oops, value of c2 ("{}val3"{}) missing in inputs to write\_res\_params(). :-\/( '}}
...
\DoxyCodeLine{112                     error stop \textcolor{stringliteral}{'Error: Oops, value of c2 ("{}val3"{}) missing in inputs to write\_res\_params(). :-\/( '}}
...
\DoxyCodeLine{116             error stop \textcolor{stringliteral}{'Error: Oops, invalid "{}p\_system"{} passed to function write\_res\_params(). :-\/( '}}
...
\DoxyCodeLine{125             error stop \textcolor{stringliteral}{'Error: Oops, invalid RESTART namelist defined in function write\_res\_params(). :-\/( '}}
...
\DoxyCodeLine{162             error stop \textcolor{stringliteral}{'Error: Oops, this restart file is not present in the current directory. :-\/( '}}
...
\DoxyCodeLine{171             error stop \textcolor{stringliteral}{'Error: Oops, invalid RESTART namelist in "{}res\_nml.txt"{}. :-\/( '}}
...
\DoxyCodeLine{226             error stop \textcolor{stringliteral}{'Error: Oops, this restart file is not present in the current directory. :-\/( '}}
...
\DoxyCodeLine{264             error stop \textcolor{stringliteral}{'Error: Oops, this restart file is not present in the current directory. :-\/( '}}
