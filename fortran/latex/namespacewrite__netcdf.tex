...
\DoxyCodeLine{147 \textcolor{keywordtype}{        real}, \textcolor{keywordtype}{intent(in)}, \textcolor{keywordtype}{dimension(:)} :: trace}
...
\DoxyCodeLine{150 \textcolor{keywordtype}{        real}, \textcolor{keywordtype}{intent(in)} :: accept\_rate}
\DoxyCodeLine{151     }
\DoxyCodeLine{152     }
...
\DoxyCodeLine{224 \textcolor{keywordtype}{        real}, \textcolor{keywordtype}{intent(in)}, \textcolor{keywordtype}{dimension(:)} :: trace}
...
\DoxyCodeLine{227 \textcolor{keywordtype}{        real}, \textcolor{keywordtype}{intent(in)} :: accept\_rate}
\DoxyCodeLine{228     }
\DoxyCodeLine{229     }
...
\DoxyCodeLine{349     }
\DoxyCodeLine{350         ierr = nf90\_def\_var(file\_id, \textcolor{stringliteral}{"{}energy\_at\_alphas\_array"{}}, nf90\_real\textcolor{comment}{, dim\_id, var\_id\_)}}
...
\DoxyCodeLine{389 \textcolor{keywordtype}{        real}, \textcolor{keywordtype}{intent(in)}, \textcolor{keywordtype}{dimension(:)} :: bondlength\_array, energy\_array}
...
\DoxyCodeLine{392 \textcolor{keywordtype}{        real}, \textcolor{keywordtype}{intent(in)}, \textcolor{keywordtype}{dimension(:)} :: accept\_rate}
\DoxyCodeLine{393     }
\DoxyCodeLine{394     }
...
\DoxyCodeLine{438     }
\DoxyCodeLine{439         ierr = nf90\_def\_var(file\_id, \textcolor{stringliteral}{"{}energy\_at\_bondlengths\_array"{}}, nf90\_real\textcolor{comment}{, dim\_id, var\_id\_)}}
...
\DoxyCodeLine{478 \textcolor{keywordtype}{        real}, \textcolor{keywordtype}{intent(in)}, \textcolor{keywordtype}{dimension(:)} :: bondlength\_array, energy\_array}
...
\DoxyCodeLine{481 \textcolor{keywordtype}{        real}, \textcolor{keywordtype}{intent(in)}, \textcolor{keywordtype}{dimension(:)} :: accept\_rate}
\DoxyCodeLine{482     }
\DoxyCodeLine{483     }
...
\DoxyCodeLine{527     }
\DoxyCodeLine{528         ierr = nf90\_def\_var(file\_id, \textcolor{stringliteral}{"{}energy\_at\_bondlengths\_array"{}}, nf90\_real\textcolor{comment}{, dim\_id, var\_id\_)}}
...
Definition at line 551 of file netcdf\+\_\+out.\+f90.


\begin{DoxyCode}{0}
\DoxyCodeLine{552     \textcolor{comment}{! Declaring inpit variables}}
\DoxyCodeLine{553 \textcolor{keywordtype}{    real}, \textcolor{keywordtype}{intent(in)}, \textcolor{keywordtype}{dimension(:)} :: array}
\DoxyCodeLine{554     \textcolor{keywordtype}{character(len=*)}, \textcolor{keywordtype}{intent(in)} :: filename}
\DoxyCodeLine{555 }
\DoxyCodeLine{556     \textcolor{comment}{! Declaring other variables}}
\DoxyCodeLine{557     \textcolor{keywordtype}{integer}, \textcolor{keywordtype}{parameter} :: ndims=1  \textcolor{comment}{! Dimension of array (1D)}}
\DoxyCodeLine{558     \textcolor{keywordtype}{integer}, \textcolor{keywordtype}{dimension(ndims)} :: dim\_id  \textcolor{comment}{! Size of array and dimension ID}}
\DoxyCodeLine{559     \textcolor{keywordtype}{character(len=1)}, \textcolor{keywordtype}{dimension(ndims)} :: dims=(/\textcolor{stringliteral}{"{}t"{}}/)  \textcolor{comment}{! Write along t axis}}
\DoxyCodeLine{560     \textcolor{keywordtype}{integer} :: ierr, file\_id, var\_id, i, array\_length  \textcolor{comment}{! Error check status, file and variable ID, iterator}}
\DoxyCodeLine{561     \textcolor{keywordtype}{integer}, \textcolor{keywordtype}{dimension(1)} :: start\_array}
\DoxyCodeLine{562 }
\DoxyCodeLine{563 }
\DoxyCodeLine{564     \textcolor{comment}{! Open existing NetCDF file in read / write mode}}
\DoxyCodeLine{565     ierr = nf90\_open(filename, nf90\_write, file\_id)}
\DoxyCodeLine{566     \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{567 }
\DoxyCodeLine{568     \textcolor{comment}{! Grab variable ID of Trace / 1D array}}
\DoxyCodeLine{569     ierr = nf90\_inq\_varid(file\_id, \textcolor{stringliteral}{"{}Trace"{}}, var\_id)}
\DoxyCodeLine{570     \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{571 }
\DoxyCodeLine{572     \textcolor{comment}{! Grab dimension ID of Trace / 1D array ("{}t"{})}}
\DoxyCodeLine{573     \textcolor{keywordflow}{do} i = 1, ndims}
\DoxyCodeLine{574         ierr = nf90\_inq\_dimid(file\_id, dims(i), dim\_id(i))}
\DoxyCodeLine{575         \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{576 \textcolor{keywordflow}{    enddo}}
\DoxyCodeLine{577 }
\DoxyCodeLine{578     \textcolor{comment}{! Grab length of dimension / 1D array}}
\DoxyCodeLine{579     ierr = nf90\_inquire\_dimension(file\_id, dim\_id(1), dims(1), array\_length)}
\DoxyCodeLine{580     \textcolor{keyword}{call }error\_check(ierr)}
\DoxyCodeLine{581 }
\DoxyCodeLine{582     start\_array(1) = array\_length}
\DoxyCodeLine{583 }
\DoxyCodeLine{584     \textcolor{comment}{! Write new data to end of 1D array }}
\DoxyCodeLine{585     ierr = nf90\_put\_var(file\_id, var\_id, array, start=start\_array)}
