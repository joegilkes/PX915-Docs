...
\DoxyCodeLine{121 }
\DoxyCodeLine{122 \textcolor{keywordtype}{        real}(real64) :: H1s\_wfn, expfac}
\DoxyCodeLine{123 }
\DoxyCodeLine{124         expfac = -\/norm2(r\_elec -\/ r\_nuc)}
\DoxyCodeLine{125 }
\DoxyCodeLine{126         h1s\_wfn = pi\_dash * exp(expfac)}
\DoxyCodeLine{127 }
...
Definition at line 150 of file quantum\+\_\+solvers.\+f90.
...
\DoxyCodeLine{153 }
\DoxyCodeLine{154 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{intent(in)} :: r\_elec, R\_nuc}
\DoxyCodeLine{155 }
\DoxyCodeLine{156 \textcolor{keywordtype}{        real}(real64) :: H2s\_wfn, prefac, expfac, r\_norm}
\DoxyCodeLine{157 }
\DoxyCodeLine{158         r\_norm = norm2(r\_elec -\/ r\_nuc)}
\DoxyCodeLine{159         prefac = pi\_dash\_2 * (2 -\/ r\_norm)}
\DoxyCodeLine{160         expfac = -\/(r\_norm / 2)}
\DoxyCodeLine{161 }
\DoxyCodeLine{162         h2s\_wfn = prefac * exp(expfac)}
\DoxyCodeLine{163 }
...
Definition at line 195 of file quantum\+\_\+solvers.\+f90.
...
\DoxyCodeLine{198 }
\DoxyCodeLine{199 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(:)}, \textcolor{keywordtype}{intent(in)} :: c}
\DoxyCodeLine{200 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{intent(in)} :: r}
\DoxyCodeLine{201 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{intent(in)} :: R\_a, R\_b}
\DoxyCodeLine{202 }
\DoxyCodeLine{203 \textcolor{keywordtype}{        real}(real64) :: wfn}
\DoxyCodeLine{204 }
\DoxyCodeLine{205         \textcolor{keywordflow}{if} (h2plus\%include\_pqn .eq. 1) \textcolor{keywordflow}{then}}
\DoxyCodeLine{206             wfn = (c(1) * h1s\_wfn(r, r\_a)) + (sqrt(1 -\/ (c(1)*c(1))) * h1s\_wfn\textcolor{comment}{(r, r\_b))}}
\DoxyCodeLine{207 \textcolor{comment}{}        \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (h2plus\%include\_pqn .eq. 2) \textcolor{keywordflow}{then}}
\DoxyCodeLine{208             wfn = (c(1) * h1s\_wfn(r, r\_a)) + (sqrt(1 -\/ (c(1)*c(1))) * h1s\_wfn\textcolor{comment}{(r, r\_b)) \&}}
\DoxyCodeLine{209 \textcolor{comment}{}                    + (c(2) * h2s\_wfn(r, r\_a)) + (sqrt(1 -\/ (c(2)*c(2))) \textcolor{comment}{* h2s\_wfn(r, r\_b))}}
\DoxyCodeLine{210 \textcolor{comment}{}        \textcolor{keywordflow}{else}}
\DoxyCodeLine{211             error stop \textcolor{stringliteral}{'Global include\_pqn can only take values 1 or 2.'}}
...
Definition at line 236 of file quantum\+\_\+solvers.\+f90.
...
\DoxyCodeLine{239 }
\DoxyCodeLine{240 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(:)}, \textcolor{keywordtype}{intent(in)} :: c}
\DoxyCodeLine{241 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{intent(in)} :: r\_current, r\_next}
\DoxyCodeLine{242 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{intent(in)} :: R\_a, R\_b}
\DoxyCodeLine{243 }
\DoxyCodeLine{244 \textcolor{keywordtype}{        real}(real64) :: Prob}
\DoxyCodeLine{245 }
\DoxyCodeLine{246         prob = h\_2\_plus\_wfn(c, r\_next, r\_a, r\_b) / h\_2\_plus\_wfn(c, r\_current\textcolor{comment}{, r\_a, r\_b)}}
...
Definition at line 274 of file quantum\+\_\+solvers.\+f90.
...
\DoxyCodeLine{277 }
\DoxyCodeLine{278 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(:)}, \textcolor{keywordtype}{intent(in)} :: c}
\DoxyCodeLine{279 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{intent(in)} :: r}
\DoxyCodeLine{280 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{intent(in)} :: R\_a, R\_b}
\DoxyCodeLine{281 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{optional} :: fdstep}
\DoxyCodeLine{282 }
\DoxyCodeLine{283 \textcolor{keywordtype}{        real}(real64) :: step                    \textcolor{comment}{! Auxiliary variable for defaulting}}
\DoxyCodeLine{284 \textcolor{keywordtype}{        real}(real64) :: laplacian               \textcolor{comment}{! 2nd derivative of trial wavefunction}}
\DoxyCodeLine{285 \textcolor{keywordtype}{        real}(real64) :: coulomb                 \textcolor{comment}{! Coulomb terms of Hamiltonian}}
\DoxyCodeLine{286 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)} :: r\_temp}
\DoxyCodeLine{287 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(2, 3)} :: diffs  \textcolor{comment}{! Wavefunction finite differences}}
...
\DoxyCodeLine{290 }
\DoxyCodeLine{291 \textcolor{keywordtype}{        real}(real64) :: E\_loc}
\DoxyCodeLine{292 }
\DoxyCodeLine{293         \textcolor{comment}{! Allow the finite difference step size to take a default value.}}
\DoxyCodeLine{294         \textcolor{keywordflow}{if} (\textcolor{keyword}{present}(fdstep)) \textcolor{keywordflow}{then}}
\DoxyCodeLine{295             step = fdstep}
\DoxyCodeLine{296         \textcolor{keywordflow}{else}}
\DoxyCodeLine{297             step = 1e-\/3\_real64}
...
\DoxyCodeLine{308             diffs(1, i) = h\_2\_plus\_wfn(c, r\_temp, r\_a, r\_b)}
\DoxyCodeLine{309 }
\DoxyCodeLine{310             r\_temp(i) = r(i) + step}
\DoxyCodeLine{311             diffs(2, i) = h\_2\_plus\_wfn(c, r\_temp, r\_a, r\_b)}
\DoxyCodeLine{312 \textcolor{keywordflow}{        end do}}
\DoxyCodeLine{313 }
\DoxyCodeLine{314         \textcolor{comment}{! Assemble Hamiltonian}}
\DoxyCodeLine{315         laplacian = ((diffs(1, 1) -\/ wfnx2 + diffs(2, 1)) + \&}
\DoxyCodeLine{316                      (diffs(1, 2) -\/ wfnx2 + diffs(2, 2)) + \&}
\DoxyCodeLine{317                      (diffs(1, 3) -\/ wfnx2 + diffs(2, 3))) / (step*step)}
\DoxyCodeLine{318         laplacian = laplacian * (-\/0.5\_real64)}
\DoxyCodeLine{319 }
\DoxyCodeLine{320         coulomb = (-\/(1  / norm2(r -\/ r\_a)) -\/ (1 / norm2(r -\/ r\_b))) * wfn}
\DoxyCodeLine{321         }
\DoxyCodeLine{322         e\_loc = (laplacian + coulomb) / wfn}
\DoxyCodeLine{323         }
...
Definition at line 360 of file quantum\+\_\+solvers.\+f90.


\begin{DoxyCode}{0}
\DoxyCodeLine{361 }
\DoxyCodeLine{362         \textcolor{keywordtype}{implicit none}}
\DoxyCodeLine{363 }
\DoxyCodeLine{364 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(:)}, \textcolor{keywordtype}{intent(in)} :: c}
\DoxyCodeLine{365 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{intent(in)} :: r\_1, r\_2}
\DoxyCodeLine{366 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{intent(in)} :: R\_a, R\_b}
\DoxyCodeLine{367 }
\DoxyCodeLine{368 \textcolor{keywordtype}{        real}(real64) :: wfn}
\DoxyCodeLine{369 }
\DoxyCodeLine{370         \textcolor{keywordflow}{if} (h2\%include\_pqn .eq. 1) \textcolor{keywordflow}{then}}
\DoxyCodeLine{371             wfn = c(1) * ((h1s\_wfn(r\_1, r\_a) * h1s\_wfn(r\_2, r\_b)) \&}
\DoxyCodeLine{372                   + (h1s\_wfn(r\_2, r\_a) * h1s\_wfn(r\_1, r\_b)))}
\DoxyCodeLine{373         \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (h2\%include\_pqn .eq. 2) \textcolor{keywordflow}{then}}
\DoxyCodeLine{374             wfn = c(1) * ((h1s\_wfn(r\_1, r\_a) * h1s\_wfn(r\_2, r\_b)) \&}
\DoxyCodeLine{375                   + (h1s\_wfn(r\_2, r\_a) * h1s\_wfn(r\_1, r\_b))) + \& }
\DoxyCodeLine{376                   c(2) * ((h2s\_wfn(r\_1, r\_a) * h2s\_wfn(r\_2, r\_b)) \&}
\DoxyCodeLine{377                   + (h2s\_wfn(r\_2, r\_a) * h2s\_wfn(r\_1, r\_b)))}
\DoxyCodeLine{378         \textcolor{keywordflow}{else}}
\DoxyCodeLine{379             error stop \textcolor{stringliteral}{'Global include\_pqn can only take values 1 or 2.'}}
...
Definition at line 407 of file quantum\+\_\+solvers.\+f90.


\begin{DoxyCode}{0}
\DoxyCodeLine{409 }
\DoxyCodeLine{410         \textcolor{keywordtype}{implicit none}}
\DoxyCodeLine{411 }
\DoxyCodeLine{412 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(:)}, \textcolor{keywordtype}{intent(in)} :: c}
\DoxyCodeLine{413 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{intent(in)} :: r\_1\_current, r\_2\_current}
\DoxyCodeLine{414 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{intent(in)} :: r\_1\_next, r\_2\_next}
\DoxyCodeLine{415 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{intent(in)} :: R\_a, R\_b}
\DoxyCodeLine{416 }
\DoxyCodeLine{417 \textcolor{keywordtype}{        real}(real64) :: Prob}
\DoxyCodeLine{418 }
\DoxyCodeLine{419         prob = h\_2\_wfn(c, r\_1\_next, r\_2\_next, r\_a, r\_b) / \&}
\DoxyCodeLine{420                h\_2\_wfn(c, r\_1\_current, r\_2\_current, r\_a, r\_b)}
\DoxyCodeLine{421 }
...
Definition at line 453 of file quantum\+\_\+solvers.\+f90.
...
\DoxyCodeLine{456 }
\DoxyCodeLine{457 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(:)}, \textcolor{keywordtype}{intent(in)} :: c}
\DoxyCodeLine{458 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{intent(in)} :: r\_1, r\_2}
\DoxyCodeLine{459 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{intent(in)} :: R\_a, R\_b}
\DoxyCodeLine{460 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{optional} :: fdstep}
\DoxyCodeLine{461 }
\DoxyCodeLine{462 \textcolor{keywordtype}{        real}(real64) :: step                                \textcolor{comment}{! Auxiliary variable for defaulting}}
\DoxyCodeLine{463 \textcolor{keywordtype}{        real}(real64) :: laplacian                           \textcolor{comment}{! 2nd derivative of trial wavefunction}}
\DoxyCodeLine{464 \textcolor{keywordtype}{        real}(real64) :: coulomb                             \textcolor{comment}{! Coulomb terms of Hamiltonian}}
\DoxyCodeLine{465 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)} :: r\_1\_temp, r\_2\_temp}
\DoxyCodeLine{466 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(2, 3)} :: diffs\_1, diffs\_2   \textcolor{comment}{! Wavefunction finite differences}}
\DoxyCodeLine{467 \textcolor{keywordtype}{        real}(real64) :: wfn, wfnx2                          \textcolor{comment}{! Wavefunction at walker positions}}
\DoxyCodeLine{468         \textcolor{keywordtype}{integer} :: backdiff, forwdiff}
\DoxyCodeLine{469         \textcolor{keywordtype}{integer} :: i}
\DoxyCodeLine{470 }
\DoxyCodeLine{471 \textcolor{keywordtype}{        real}(real64) :: E\_loc}
\DoxyCodeLine{472 }
\DoxyCodeLine{473         \textcolor{comment}{! Allow the finite difference step size to take a default value.}}
\DoxyCodeLine{474         \textcolor{keywordflow}{if} (\textcolor{keyword}{present}(fdstep)) \textcolor{keywordflow}{then}}
\DoxyCodeLine{475             step = fdstep}
\DoxyCodeLine{476         \textcolor{keywordflow}{else}}
\DoxyCodeLine{477             step = 1e-\/3\_real64}
\DoxyCodeLine{478 \textcolor{keywordflow}{        end if}}
\DoxyCodeLine{479 }
\DoxyCodeLine{480         \textcolor{comment}{! Calculate trial wavefunction at provided walker positions.}}
\DoxyCodeLine{481         wfn = h\_2\_wfn(c, r\_1, r\_2, r\_a, r\_b)}
\DoxyCodeLine{482         wfnx2 = 2 * wfn \textcolor{comment}{! Reduce unneccessary multiplication}}
\DoxyCodeLine{483 }
\DoxyCodeLine{484         backdiff = 1}
\DoxyCodeLine{485         forwdiff = 2}
\DoxyCodeLine{486         \textcolor{comment}{! Calculate trial wavefunction in finite difference directions.}}
\DoxyCodeLine{487         \textcolor{keywordflow}{do} i = 1, 3}
\DoxyCodeLine{488             r\_1\_temp = r\_1}
\DoxyCodeLine{489             r\_2\_temp = r\_2}
\DoxyCodeLine{490             r\_1\_temp(i) = r\_1(i) -\/ step}
\DoxyCodeLine{491             r\_2\_temp(i) = r\_2(i) -\/ step}
\DoxyCodeLine{492             diffs\_1(backdiff, i) = h\_2\_wfn(c, r\_1\_temp, r\_2, r\_a, r\_b)}
\DoxyCodeLine{493             diffs\_2(backdiff, i) = h\_2\_wfn(c, r\_1, r\_2\_temp, r\_a, r\_b)}
\DoxyCodeLine{494 }
\DoxyCodeLine{495             r\_1\_temp(i) = r\_1(i) + step}
\DoxyCodeLine{496             r\_2\_temp(i) = r\_2(i) + step}
\DoxyCodeLine{497             diffs\_1(forwdiff, i) = h\_2\_wfn(c, r\_1\_temp, r\_2, r\_a, r\_b)}
\DoxyCodeLine{498             diffs\_2(forwdiff, i) = h\_2\_wfn(c, r\_1, r\_2\_temp, r\_a, r\_b)}
\DoxyCodeLine{499 \textcolor{keywordflow}{        end do}}
\DoxyCodeLine{500 }
\DoxyCodeLine{501         \textcolor{comment}{! Assemble Hamiltonian.}}
\DoxyCodeLine{502         laplacian = (((diffs\_1(backdiff, 1) -\/ wfnx2 + diffs\_1(forwdiff, \textcolor{comment}{1)) + \&}}
\DoxyCodeLine{503 \textcolor{comment}{}                      (diffs\_1(backdiff, 2) -\/ wfnx2 + diffs\_1(forwdiff, \textcolor{comment}{2)) + \&}}
\DoxyCodeLine{504 \textcolor{comment}{}                      (diffs\_1(backdiff, 3) -\/ wfnx2 + diffs\_1(forwdiff, \textcolor{comment}{3))) + \&}}
\DoxyCodeLine{505 \textcolor{comment}{}                     ((diffs\_2(backdiff, 1) -\/ wfnx2 + diffs\_2(forwdiff, \textcolor{comment}{1)) + \&}}
\DoxyCodeLine{506 \textcolor{comment}{}                      (diffs\_2(backdiff, 2) -\/ wfnx2 + diffs\_2(forwdiff, \textcolor{comment}{2)) + \&}}
\DoxyCodeLine{507 \textcolor{comment}{}                      (diffs\_2(backdiff, 3) -\/ wfnx2 + diffs\_2(forwdiff, \textcolor{comment}{3)))) \&}}
\DoxyCodeLine{508 \textcolor{comment}{}                    / (step*step)}
\DoxyCodeLine{509         laplacian = laplacian * (-\/0.5\_real64)}
\DoxyCodeLine{510 }
\DoxyCodeLine{511         coulomb = (-\/ (1 / norm2(r\_1 -\/ r\_a)) -\/ (1 / norm2(r\_1 -\/ r\_b)) \&}
\DoxyCodeLine{512                    -\/ (1 / norm2(r\_2 -\/ r\_a)) -\/ (1 / norm2(r\_2 -\/ r\_b)) \&}
\DoxyCodeLine{513                    + (1 / norm2(r\_1 -\/ r\_2))) * wfn}
\DoxyCodeLine{514         }
\DoxyCodeLine{515         e\_loc = (laplacian + coulomb) / wfn}
\DoxyCodeLine{516         }
