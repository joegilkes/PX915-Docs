...
\DoxyCodeLine{356                     \textcolor{comment}{! Calculates the local energy at this point }}
...
\DoxyCodeLine{379                     x\_burnt(i -\/ burn -\/ (reset\_counter * thin)) = x(i-\/1)}
\DoxyCodeLine{380                     energy\_chain(i -\/ burn -\/ (reset\_counter * thin)) = qho\_energy\textcolor{comment}{(alpha\_const, x(i-\/1))}}
\DoxyCodeLine{381 \textcolor{comment}{}                    thin\_counter = 0 }
\DoxyCodeLine{382 }
\DoxyCodeLine{383                     acceptance = \textcolor{stringliteral}{'N'}}
\DoxyCodeLine{384 \textcolor{keywordflow}{                end if} }
\DoxyCodeLine{385 \textcolor{keywordflow}{            end if} }
\DoxyCodeLine{386 }
\DoxyCodeLine{387             \textcolor{keywordflow}{if} (verbose) \textcolor{keywordflow}{then}}
\DoxyCodeLine{388                 \textcolor{keywordflow}{if} (mod(i, 1) .eq. 0.0) \textcolor{keywordflow}{then}}
\DoxyCodeLine{389                 \textcolor{keyword}{write}(logid, \textcolor{stringliteral}{"{}(F12.8, '   ', F12.8, '     ', A1)"{}}) \&}
\DoxyCodeLine{390                     x(i), energy\_chain(i), acceptance}
...
\DoxyCodeLine{394 }
\DoxyCodeLine{395         \textcolor{comment}{! if (verbose) write(logid, "{}('')"{})}}
\DoxyCodeLine{396         \textcolor{keyword}{write}(*, *) \textcolor{stringliteral}{'[Temp output] variable accept = '}, accept}
\DoxyCodeLine{397         \textcolor{keywordflow}{if} (verbose) \textcolor{keyword}{write}(0, \textcolor{stringliteral}{"{}('')"{}})}
\DoxyCodeLine{398 }
\DoxyCodeLine{399         \textcolor{comment}{! Calculate the acceptance ratio }}
\DoxyCodeLine{400         accept\_rate = (real(accept, kind=real64) / real(n, kind=real64))\textcolor{comment}{ }}
...
Definition at line 431 of file vqmc.\+f90.
...
\DoxyCodeLine{435 }
\DoxyCodeLine{436 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{intent(in)}, \textcolor{keywordtype}{dimension(3)} :: R\_a, R\_b}
\DoxyCodeLine{437 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{intent(in)} :: sigma}
\DoxyCodeLine{438 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{intent(in)}, \textcolor{keywordtype}{dimension(:)} :: c\_const}
\DoxyCodeLine{439 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{optional} :: x\_start}
\DoxyCodeLine{440         \textcolor{keywordtype}{integer}, \textcolor{keywordtype}{intent(in)} :: N, burn, thin }
\DoxyCodeLine{441         }
\DoxyCodeLine{442          }
\DoxyCodeLine{443 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{intent(out)} :: accept\_rate}
\DoxyCodeLine{444 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{intent(out)}, \textcolor{keywordtype}{dimension(:, :)}, \textcolor{keywordtype}{allocatable} :: X}
\DoxyCodeLine{445 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{intent(out)}, \textcolor{keywordtype}{dimension(:)}, \textcolor{keywordtype}{allocatable} :: energy\_chain}
\DoxyCodeLine{446 }
\DoxyCodeLine{447 \textcolor{keywordtype}{        real}(real64) :: log\_prob\_n                      \textcolor{comment}{! The natural logarithm of the transition proability}}
\DoxyCodeLine{448 \textcolor{keywordtype}{        real}(real64) :: a\_prob\_trans                    \textcolor{comment}{! Acceptance ratio of the transitional probability }}
\DoxyCodeLine{449 \textcolor{keywordtype}{        real}(real64) :: unif\_num                        \textcolor{comment}{! A random sample from the uniform distribution }}
\DoxyCodeLine{450 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)} :: start             \textcolor{comment}{! Starting point of MCMC chain}}
\DoxyCodeLine{451 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)} :: X\_n               \textcolor{comment}{! The proposed step }}
\DoxyCodeLine{452 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)} :: sample\_normal     \textcolor{comment}{! A sample from the normal distribution }}
\DoxyCodeLine{453         \textcolor{keywordtype}{integer} :: accept                               \textcolor{comment}{! Number of accepted steps }}
\DoxyCodeLine{454         \textcolor{keywordtype}{integer} :: i                                    \textcolor{comment}{! Loop variable }}
\DoxyCodeLine{455         }
\DoxyCodeLine{456         \textcolor{keyword}{allocate}(x(3, 1:n+1)) }
\DoxyCodeLine{457         \textcolor{keyword}{allocate}(energy\_chain(1:n+1))}
\DoxyCodeLine{458 }
\DoxyCodeLine{459         \textcolor{comment}{! Allow the starting position to take on the default value}}
\DoxyCodeLine{460         \textcolor{keywordflow}{if} (\textcolor{keyword}{present}(x\_start)) \textcolor{keywordflow}{then} }
\DoxyCodeLine{461             start = x\_start}
\DoxyCodeLine{462             x(:,1) = start }
\DoxyCodeLine{463         \textcolor{keywordflow}{else} }
\DoxyCodeLine{464             \textcolor{comment}{! Create the initial position of the random walker that is within a certain radius }}
\DoxyCodeLine{465             \textcolor{keywordflow}{do} \textcolor{keywordflow}{while}(norm2(sample\_normal) <= h2plus\%rcut )}
\DoxyCodeLine{466                 \textcolor{keyword}{call }random\_normal(3, sample\_normal)}
\DoxyCodeLine{467 \textcolor{keywordflow}{            end do} }
\DoxyCodeLine{468             start = sample\_normal}
\DoxyCodeLine{469             x(:,1) = start }
\DoxyCodeLine{470 \textcolor{keywordflow}{        end if}}
\DoxyCodeLine{471 }
\DoxyCodeLine{472         \textcolor{comment}{! Calculate the local energy of the initial step }}
\DoxyCodeLine{473         energy\_chain(1) = h\_2\_plus\_energy(c\_const, x(:, 1), r\_a, r\_b)}
\DoxyCodeLine{474 }
\DoxyCodeLine{475         \textcolor{comment}{! Start the counter for the number of accepted moves}}
\DoxyCodeLine{476         accept = 0  }
\DoxyCodeLine{477 }
\DoxyCodeLine{478         \textcolor{comment}{! Metropolis algorithm }}
\DoxyCodeLine{479         \textcolor{keywordflow}{do} i = 2, n+1 }
\DoxyCodeLine{480             \textcolor{comment}{! Propose the next step }}
\DoxyCodeLine{481             \textcolor{keyword}{call }random\_normal(3, sample\_normal)}
\DoxyCodeLine{482             x\_n = x(:, i-\/1) + sigma * sample\_normal}
\DoxyCodeLine{483 }
\DoxyCodeLine{484             \textcolor{comment}{! Calculate the transition probability between proposed step and current step }}
\DoxyCodeLine{485             log\_prob\_n = log(h\_2\_plus\_prob(c\_const, x(:, i-\/1), x\_n, r\_a,\textcolor{comment}{ r\_b))}}
\DoxyCodeLine{486 \textcolor{comment}{}           }
\DoxyCodeLine{487             \textcolor{comment}{! Calculate the acceptance ratio }}
\DoxyCodeLine{488             a\_prob\_trans = min(1.0\_real64, exp(log\_prob\_n))}
\DoxyCodeLine{489             }
\DoxyCodeLine{490             \textcolor{comment}{! Generate sample from uniform distribution}}
\DoxyCodeLine{491             \textcolor{keyword}{call }ran1(unif\_num, seed)}
\DoxyCodeLine{492 }
\DoxyCodeLine{493             \textcolor{comment}{! Compare the drawn sample from the uniform distribution with the acceptance ratio}}
\DoxyCodeLine{494             \textcolor{keywordflow}{if} (a\_prob\_trans >= unif\_num) \textcolor{keywordflow}{then} }
\DoxyCodeLine{495                 \textcolor{comment}{! If accepted calculate local energy and add proposed position to the MCMC chain}}
\DoxyCodeLine{496                 x(:, i) = x\_n }
\DoxyCodeLine{497                 energy\_chain(i) = h\_2\_plus\_energy(c\_const, x\_n, r\_a, r\_b\textcolor{comment}{)}}
\DoxyCodeLine{498 \textcolor{comment}{}                }
\DoxyCodeLine{499                 \textcolor{comment}{! Increment by the number of accepted steps }}
\DoxyCodeLine{500                 accept = 1 + accept }
\DoxyCodeLine{501             \textcolor{keywordflow}{else}}
\DoxyCodeLine{502                 \textcolor{comment}{! If rejected the proposed step is the current step }}
\DoxyCodeLine{503                 x(:, i) = x(:, i-\/1)}
\DoxyCodeLine{504                 }
\DoxyCodeLine{505                 \textcolor{comment}{! The local energy of the proposed step is the same as the current step when rejected}}
\DoxyCodeLine{506                 energy\_chain(i) = energy\_chain(i-\/1)}
\DoxyCodeLine{507 \textcolor{keywordflow}{            end if} }
\DoxyCodeLine{508 \textcolor{keywordflow}{        end do} }
\DoxyCodeLine{509 }
\DoxyCodeLine{510         \textcolor{comment}{! Calculate the acceptance ratio}}
\DoxyCodeLine{511         accept\_rate = (real(accept, kind=real64) / real(n, kind=real64))\textcolor{comment}{ }}
...
Definition at line 544 of file vqmc.\+f90.


\begin{DoxyCode}{0}
\DoxyCodeLine{546 }
\DoxyCodeLine{547         \textcolor{keywordtype}{implicit none} }
\DoxyCodeLine{548 }
\DoxyCodeLine{549 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{intent(in)}, \textcolor{keywordtype}{dimension(3)} :: R\_a, R\_b}
\DoxyCodeLine{550 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{intent(in)} :: sigma}
\DoxyCodeLine{551 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{intent(in)}, \textcolor{keywordtype}{dimension(:)} :: c\_const }
\DoxyCodeLine{552 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)}, \textcolor{keywordtype}{optional} :: x\_start\_1, x\_start\_2}
\DoxyCodeLine{553         \textcolor{keywordtype}{integer}, \textcolor{keywordtype}{intent(in)} :: N, burn, thin }
\DoxyCodeLine{554         }
\DoxyCodeLine{555          }
\DoxyCodeLine{556 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{intent(out)} :: accept\_rate}
\DoxyCodeLine{557 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{intent(out)}, \textcolor{keywordtype}{dimension(:, :)}, \textcolor{keywordtype}{allocatable} :: X\_1, X\_2}
\DoxyCodeLine{558 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{intent(out)}, \textcolor{keywordtype}{dimension(:)}, \textcolor{keywordtype}{allocatable} :: energy\_chain}
\DoxyCodeLine{559 }
\DoxyCodeLine{560 \textcolor{keywordtype}{        real}(real64) :: log\_prob\_n                              \textcolor{comment}{! The natural logarithm of the transition proability }}
\DoxyCodeLine{561 \textcolor{keywordtype}{        real}(real64) :: a\_prob\_trans                            \textcolor{comment}{! Acceptance ratio of the transitional probability                   }}
\DoxyCodeLine{562 \textcolor{keywordtype}{        real}(real64) :: unif\_num                                \textcolor{comment}{! A random sample from the uniform distribution }}
\DoxyCodeLine{563 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)} :: start\_1, start\_2          \textcolor{comment}{! Starting points for the random walkers }}
\DoxyCodeLine{564 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)} :: X\_n\_1, X\_n\_2              \textcolor{comment}{! The propsed steps for the random walkers }}
\DoxyCodeLine{565 \textcolor{keywordtype}{        real}(real64), \textcolor{keywordtype}{dimension(3)} :: sample\_normal             \textcolor{comment}{! Sample from the normal distribution }}
\DoxyCodeLine{566         \textcolor{keywordtype}{integer} :: accept                                       \textcolor{comment}{! Number of accepted steps }}
\DoxyCodeLine{567         \textcolor{keywordtype}{integer} :: i                                            \textcolor{comment}{! Loop variable }}
\DoxyCodeLine{568         }
\DoxyCodeLine{569         \textcolor{keyword}{allocate}(x\_1(3, 1:n+1)) }
\DoxyCodeLine{570         \textcolor{keyword}{allocate}(x\_2(3, 1:n+1))}
\DoxyCodeLine{571         \textcolor{keyword}{allocate}(energy\_chain(1:n+1))}
\DoxyCodeLine{572 }
\DoxyCodeLine{573         \textcolor{comment}{! Allow the starting position to take on the default value }}
\DoxyCodeLine{574         \textcolor{keywordflow}{if} (\textcolor{keyword}{present}(x\_start\_1) .and. \textcolor{keyword}{present}(x\_start\_2)) \textcolor{keywordflow}{then}}
\DoxyCodeLine{575             start\_1 = x\_start\_1}
\DoxyCodeLine{576             x\_1(:,1) = start\_1}
\DoxyCodeLine{577             }
\DoxyCodeLine{578             start\_2 = x\_start\_2}
\DoxyCodeLine{579             x\_2(:,1) = start\_2}
\DoxyCodeLine{580         \textcolor{keywordflow}{else} }
\DoxyCodeLine{581             \textcolor{comment}{! Create the initial position of random walker 1 that is within a certain radius}}
\DoxyCodeLine{582             \textcolor{keywordflow}{do} \textcolor{keywordflow}{while}(norm2(sample\_normal) <= h2\%rcut )}
\DoxyCodeLine{583                 \textcolor{keyword}{call }random\_normal(1, sample\_normal)}
\DoxyCodeLine{584 \textcolor{keywordflow}{            end do} }
\DoxyCodeLine{585             start\_1 = sample\_normal}
\DoxyCodeLine{586             x\_1(:,1) = start\_1}
\DoxyCodeLine{587 }
\DoxyCodeLine{588             \textcolor{comment}{! Create the initial position of random walker 2 that is within a certain radius}}
\DoxyCodeLine{589             \textcolor{keywordflow}{do} \textcolor{keywordflow}{while}(norm2(sample\_normal) <= h2\%rcut )}
\DoxyCodeLine{590                 \textcolor{keyword}{call }random\_normal(1, sample\_normal)}
\DoxyCodeLine{591 \textcolor{keywordflow}{            end do} }
\DoxyCodeLine{592             start\_2 = sample\_normal }
\DoxyCodeLine{593             x\_2(:,1) = start\_2}
\DoxyCodeLine{594 \textcolor{keywordflow}{        end if} }
\DoxyCodeLine{595         }
\DoxyCodeLine{596         \textcolor{comment}{! Calculate the local energy of the initial steps}}
\DoxyCodeLine{597         energy\_chain(1) = h\_2\_energy(c\_const, x\_1(:,1), x\_2(:,1), r\_a, r\_b\textcolor{comment}{)}}
\DoxyCodeLine{598 \textcolor{comment}{}        }
\DoxyCodeLine{599         \textcolor{comment}{! Start the counter for the number of accepted moves}}
\DoxyCodeLine{600         accept = 0  }
\DoxyCodeLine{601 }
\DoxyCodeLine{602         \textcolor{comment}{! Metropolis algorithm }}
\DoxyCodeLine{603         \textcolor{keywordflow}{do} i = 2, n+1 }
\DoxyCodeLine{604             \textcolor{comment}{! Propose the next step for random walker 1 }}
\DoxyCodeLine{605             \textcolor{keyword}{call }random\_normal(3, sample\_normal)}
\DoxyCodeLine{606             x\_n\_1 = x\_1(:, i-\/1) + sigma * sample\_normal}
\DoxyCodeLine{607 }
\DoxyCodeLine{608             \textcolor{comment}{! Propose the next step for random walker 2 }}
\DoxyCodeLine{609             \textcolor{keyword}{call }random\_normal(3, sample\_normal)}
\DoxyCodeLine{610             x\_n\_2 = x\_2(:, i-\/1) + sigma * sample\_normal}
\DoxyCodeLine{611 }
\DoxyCodeLine{612             \textcolor{comment}{! Calculate the transition probability between the proposed steps and current steps}}
\DoxyCodeLine{613             log\_prob\_n = log(h\_2\_prob(c\_const, x\_1(:, i-\/1), x\_2(:, i-\/1),\textcolor{comment}{ x\_n\_1, x\_n\_2, r\_a, r\_b))}}
\DoxyCodeLine{614 \textcolor{comment}{}}
\DoxyCodeLine{615             \textcolor{comment}{! Calculate the acceptance ratio}}
\DoxyCodeLine{616             a\_prob\_trans = min(1.0\_real64, exp(log\_prob\_n))}
\DoxyCodeLine{617 }
\DoxyCodeLine{618             \textcolor{comment}{! Generate sample from uniform distribution}}
\DoxyCodeLine{619             \textcolor{keyword}{call }ran1(unif\_num, seed)}
\DoxyCodeLine{620 }
\DoxyCodeLine{621             \textcolor{comment}{! Compare the drawn sample from the uniform distribution with the acceptance ratio}}
\DoxyCodeLine{622             \textcolor{keywordflow}{if} (a\_prob\_trans >= unif\_num) \textcolor{keywordflow}{then} }
\DoxyCodeLine{623                 \textcolor{comment}{! If accepted calculate local energy and add proposed position to the MCMC chain}}
\DoxyCodeLine{624                 x\_1(:, i) = x\_n\_1}
\DoxyCodeLine{625                 x\_2(:, i) = x\_n\_2 }
\DoxyCodeLine{626                 energy\_chain(i) = h\_2\_energy(c\_const, x\_n\_1, x\_n\_2, r\_a,\textcolor{comment}{ r\_b)}}
\DoxyCodeLine{627 \textcolor{comment}{}                }
\DoxyCodeLine{628                 \textcolor{comment}{! Increment by the number of accepted steps }}
\DoxyCodeLine{629                 accept = 1 + accept }
\DoxyCodeLine{630             \textcolor{keywordflow}{else} }
\DoxyCodeLine{631                 \textcolor{comment}{! If rejected the proposed step is the current step }}
\DoxyCodeLine{632                 x\_1(:, i) = x\_1(:, i-\/1)}
\DoxyCodeLine{633                 x\_2(:, i) = x\_2(:, i-\/1) }
\DoxyCodeLine{634                 }
\DoxyCodeLine{635                 \textcolor{comment}{! The local energy of the proposed step is the same as the current step when rejected}}
\DoxyCodeLine{636                 energy\_chain(i) = energy\_chain(i-\/1)}
\DoxyCodeLine{637 \textcolor{keywordflow}{            end if} }
\DoxyCodeLine{638 \textcolor{keywordflow}{        end do} }
\DoxyCodeLine{639 }
\DoxyCodeLine{640         \textcolor{comment}{! Calculate the acceptance ratio}}
\DoxyCodeLine{641         accept\_rate = (real(accept, kind=real64) / real(n, kind=real64))\textcolor{comment}{ }}
