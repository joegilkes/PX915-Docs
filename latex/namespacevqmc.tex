...
\begin{DoxyCompactList}\small\item\em Adaptation of numpy\textquotesingle{}s linspace function. \end{DoxyCompactList}\item 
subroutine \mbox{\hyperlink{namespacevqmc_a8b66a706cd8db1d3228f169f9a6964da}{vqmc\+\_\+qho}} (sigma, N, burn, thin, alpha\+\_\+const, x\+\_\+start, X, accept\+\_\+rate, energy\+\_\+chain)
\begin{DoxyCompactList}\small\item\em Performs VQMC for QHO. \end{DoxyCompactList}\item 
subroutine \mbox{\hyperlink{namespacevqmc_a014fdaf26103c82839fcc36c34fb9ea7}{vqmc\+\_\+h\+\_\+2\+\_\+plus}} (sigma, N, burn, thin, c\+\_\+const, R\+\_\+a, R\+\_\+b, x\+\_\+start, X, accept\+\_\+rate, energy\+\_\+chain)
\begin{DoxyCompactList}\small\item\em Performs VQMC for H\+\_\+2\+\_\+plus ~\newline
 \end{DoxyCompactList}\item 
subroutine \mbox{\hyperlink{namespacevqmc_a95b4dedd1b7e0d0c94d4f64055e30ce5}{vqmc\+\_\+h\+\_\+2}} (sigma, N, burn, thin, c\+\_\+const, R\+\_\+a, R\+\_\+b, x\+\_\+start\+\_\+1, x\+\_\+start\+\_\+2, X\+\_\+1, X\+\_\+2, accept\+\_\+rate, energy\+\_\+chain)
...
\end{center}
\end{figure}
\mbox{\Hypertarget{namespacevqmc_a8b66a706cd8db1d3228f169f9a6964da}\label{namespacevqmc_a8b66a706cd8db1d3228f169f9a6964da}} 
...
{\footnotesize\ttfamily subroutine vqmc\+::vqmc\+\_\+qho (\begin{DoxyParamCaption}\item[{real(real64), intent(in)}]{sigma,  }\item[{integer, intent(in)}]{N,  }\item[{integer, intent(in)}]{burn,  }\item[{integer, intent(in)}]{thin,  }\item[{real(real64), intent(in)}]{alpha\+\_\+const,  }\item[{real(real64), optional}]{x\+\_\+start,  }\item[{real(real64), dimension(\+:), intent(out), allocatable}]{X,  }\item[{real(real64), intent(out)}]{accept\+\_\+rate,  }\item[{real(real64), dimension(\+:), intent(out), allocatable}]{energy\+\_\+chain }\end{DoxyParamCaption})}
...
\DoxyCodeLine{269 \textcolor{keywordtype}{        real}(64), \textcolor{keywordtype}{dimension(1)} :: start                 \textcolor{comment}{! The starting point of the MCMC chain }}
...
\DoxyCodeLine{285             \textcolor{keywordflow}{do} \textcolor{keywordflow}{while}(norm2(sample\_normal) <= rcut )}
...
\DoxyCodeLine{350         accept\_rate = (real(accept, 8) / real(n, 8)) }
\DoxyCodeLine{351 }
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{namespacevqmc_a8b66a706cd8db1d3228f169f9a6964da_cgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{namespacevqmc_a014fdaf26103c82839fcc36c34fb9ea7}\label{namespacevqmc_a014fdaf26103c82839fcc36c34fb9ea7}} 
...
{\footnotesize\ttfamily subroutine vqmc\+::vqmc\+\_\+h\+\_\+2\+\_\+plus (\begin{DoxyParamCaption}\item[{real(real64), intent(in)}]{sigma,  }\item[{integer, intent(in)}]{N,  }\item[{integer, intent(in)}]{burn,  }\item[{integer, intent(in)}]{thin,  }\item[{real(real64), dimension(\+:), intent(in)}]{c\+\_\+const,  }\item[{real(real64), dimension(3), intent(in)}]{R\+\_\+a,  }\item[{real(real64), dimension(3), intent(in)}]{R\+\_\+b,  }\item[{real(real64), dimension(3), optional}]{x\+\_\+start,  }\item[{real(real64), dimension(\+:, \+:), intent(out), allocatable}]{X,  }\item[{real(real64), intent(out)}]{accept\+\_\+rate,  }\item[{real(real64), dimension(\+:), intent(out), allocatable}]{energy\+\_\+chain }\end{DoxyParamCaption})}
...
\DoxyCodeLine{415             \textcolor{keywordflow}{do} \textcolor{keywordflow}{while}(norm2(sample\_normal) <= rcut )}
...
\DoxyCodeLine{461         accept\_rate = (real(accept, 8) / real(n, 8)) }
\DoxyCodeLine{462 }
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{namespacevqmc_a014fdaf26103c82839fcc36c34fb9ea7_cgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{namespacevqmc_a95b4dedd1b7e0d0c94d4f64055e30ce5}\label{namespacevqmc_a95b4dedd1b7e0d0c94d4f64055e30ce5}} 
...
{\footnotesize\ttfamily subroutine vqmc\+::vqmc\+\_\+h\+\_\+2 (\begin{DoxyParamCaption}\item[{real(real64), intent(in)}]{sigma,  }\item[{integer, intent(in)}]{N,  }\item[{integer, intent(in)}]{burn,  }\item[{integer, intent(in)}]{thin,  }\item[{real(real64), dimension(\+:), intent(in)}]{c\+\_\+const,  }\item[{real(real64), dimension(3), intent(in)}]{R\+\_\+a,  }\item[{real(real64), dimension(3), intent(in)}]{R\+\_\+b,  }\item[{real(real64), dimension(3), optional}]{x\+\_\+start\+\_\+1,  }\item[{real(real64), dimension(3), optional}]{x\+\_\+start\+\_\+2,  }\item[{real(real64), dimension(\+:, \+:), intent(out), allocatable}]{X\+\_\+1,  }\item[{real(real64), dimension(\+:, \+:), intent(out), allocatable}]{X\+\_\+2,  }\item[{real(real64), intent(out)}]{accept\+\_\+rate,  }\item[{real(real64), dimension(\+:), intent(out), allocatable}]{energy\+\_\+chain }\end{DoxyParamCaption})}
...
\DoxyCodeLine{532             \textcolor{keywordflow}{do} \textcolor{keywordflow}{while}(norm2(sample\_normal) <= rcut )}
...
\DoxyCodeLine{539             \textcolor{keywordflow}{do} \textcolor{keywordflow}{while}(norm2(sample\_normal) <= rcut )}
...
\DoxyCodeLine{591         accept\_rate = (real(accept, 8) / real(n, 8)) }
\DoxyCodeLine{592 }
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{namespacevqmc_a95b4dedd1b7e0d0c94d4f64055e30ce5_cgraph}
\end{center}
\end{figure}
