...
\DoxyCodeLine{43 }
\DoxyCodeLine{44 \textcolor{keywordtype}{        real}(real64) :: log\_prob\_n, a\_prob\_trans, unif\_num, sample\_normal}
...
\DoxyCodeLine{58 }
\DoxyCodeLine{59             log\_prob\_n = log(qho\_prob(alpha, x(i-\/1), x\_n))}
